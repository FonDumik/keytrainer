  ...
  return (
    <div className={styles.documentation__section}>
      <Accordion header='Klavaogr'>
        <p>Это клавиатурный тренажёр. На основе различных текстов, песен, их переводов, книг, книг с переводами, субтитров к фильмам на разных языках, можно приготовить себе качественные учебные материалы.</p>
        <br/>
