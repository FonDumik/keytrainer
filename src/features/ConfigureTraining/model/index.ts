...
const configurationTrainingSlice = createSlice({
  ...
  initialState,
  reducers: {
    updateConfigurationTraining(
      state,
      action: PayloadAction<configurationTrainingType>
    ) {
...
export const { updateConfigurationTraining, updateConfigurationText } =
  configurationTrainingSlice.actions;
