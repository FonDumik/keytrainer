...
export const ConfigureTraining = () => {
  ...
  return (
    <div className={styles.container__configuration}>
      ...
      <DropdownObject
        isOpenDropDownState={{ state: isOpen, action: setIsOpen }}
        header={"Выберите режим"}
      >
        <section className={styles.configuration__sectionMenu}>
          <p>Русский</p>
          <a href="" onClick={configureRuStart}>
            Стартовый
          </a>
          <a href="" onClick={configureRuBegin}>
            Начальный
          </a>
          <a href="" onClick={configureRuTraining}>
            Тренировка
          </a>
        </section>
        <section className={styles.configuration__sectionMenu}>
          <p>English</p>
          <a href="" onClick={configureENGStart}>
            Start
          </a>
          <a href="" onClick={configureENGBegin}>
            Begin
          </a>
          <a href="" onClick={configureENGTraining}>
            Training
          </a>
        </section>
      </DropdownObject>
